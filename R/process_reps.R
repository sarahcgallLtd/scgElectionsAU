...
#'   "2004 Federal Election", "2007 Federal Election", "2010 Federal Election"). For processing
#'   years (2004, 2007, 2010), must include `Total` and
...
#'   "2004 Federal Election", "2007 Federal Election", or "2010 Federal Election". Other values
#'   result in the data being returned unprocessed.
#'
#' @return A data frame. For recognised election federal years (2004, 2007, 2010), it contains the standardised
#'   columns:
#'   \itemize{
...
process_reps <- function(data, event) {
  if (event %in% c("2004 Federal Election", "2007 Federal Election", "2010 Federal Election")) {

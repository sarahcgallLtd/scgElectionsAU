...
#' function aligns column names across election years (2010, 2013, 2016, 2019, 2022, 2025), pivots date-specific
#' vote counts into a long format (except for 2022-25), and converts issue dates to Date objects. For
...
#'   an `event` column with a single unique value (e.g., "2010", "2013", "2016", "2019", "2022", "2025").
...
#'           \item 2022-25: `Division` to `DivisionNm`, `PPVC` to `PollingPlaceNm`,
...
#'   \item For 2022-25: Selecting standardised columns without pivoting.
#'   \item Converting `IssueDate` to a Date object using year-specific formats:
#'         \itemize{
#'           \item 2025: "%d/%m/%Y" (e.g., "03/05/2025")
...
process_ppv <- function(data, event) {
  if (event %in% c("2010 Federal Election", "2013 Federal Election", "2016 Federal Election",
                   "2019 Federal Election", "2022 Federal Election", "2025 Federal Election",
                   "2023 Fadden By-Election", "2023 Aston By-Election", "2024 Cook By-Election",
                   "2024 Dunkley By-Election", "2020 Groom By-Election", "2020 Eden-Monaro By-Election",
                   "2023 Referendum","2018 Batman By-Election", "2018 Wentworth By-Election",
                   "2018 Braddon By-Election","2017 Bennelong By-Election", "2017 New England By-Election",
    ...
    } else if (event %in% c("2025 Federal Election", "2022 Federal Election", "2023 Fadden By-Election",
    ...
    if (event %in% c("2025 Federal Election", "2022 Federal Election", "2023 Fadden By-Election",
                     "2023 Aston By-Election", "2024 Cook By-Election", "2024 Dunkley By-Election",
                     "2023 Referendum")) {
    ...
    format_groups <- list(
      ...
      "%d/%m/%Y" = c("2025 Federal Election", "2019 Federal Election", "2013 Federal Election",
                     "2023 Fadden By-Election", "2023 Aston By-Election", "2024 Cook By-Election",
                     "2024 Dunkley By-Election", "2023 Referendum","2018 Wentworth By-Election",
                     "2018 Braddon By-Election", "2017 Bennelong By-Election", "2017 New England By-Election",

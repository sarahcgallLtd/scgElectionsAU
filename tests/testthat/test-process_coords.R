test_that("process_coords updates polling place coordinates correctly", {
  ...
  expect_message(
    result_2010 <- process_coords(data_2010, "2010"),
    "Filling in missing coordinates for `2010` data, where possible."
  )
  ...
  expect_message(
    result_2019 <- process_coords(data_2019, "2019"),
    "Filling in missing coordinates for `2019` data, where possible."
  )

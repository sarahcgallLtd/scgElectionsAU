test_that("process_pva_date standardises and transforms PVA data by date correctly", {
  ...
  expect_message(
    result_2022 <- process_pva_date(data_2022, "2022"),
  ...
  expect_message(
    result_2010 <- process_pva_date(data_2010, "2010"),
  ...
  expect_equal(result_2010$StateAb, c("VICTORIA", "VICTORIA"))
  ...
  expect_message(
    result_2013 <- process_pva_date(data_2013, "2013"),
  ...
  expect_message(
    result_2016 <- process_pva_date(data_2016, "2016"),
  ...
  expect_message(
    result_2019 <- process_pva_date(data_2019, "2019"),

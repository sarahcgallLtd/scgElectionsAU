test_that("process_reps standardises party representation data correctly", {
  ...
  expect_equal(names(result_2004), c("date", "event", "Party", "National", "LastElection"))
  ...
  expect_equal(names(result_2007), c("date", "event", "Party", "National", "LastElection"))
  ...
  expect_equal(names(result_2010), c("date", "event", "Party", "National", "LastElection"))

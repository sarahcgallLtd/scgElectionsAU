test_that("process_reps standardises party representation data correctly", {
  ...
  expect_message(
    result_2004 <- process_reps(data_2004, "2004 Federal Election"),
  ...
  data_2007 <- data.frame(
    date = "2007-11-24",
    event = "2007 Federal Election",
    PartyNm = "LIB",
    Total = 55,
    LastElectionTotal = 60
  )
  expect_message(
    result_2007 <- process_reps(data_2007, "2007 Federal Election"),
    "Processing `2007 Federal Election` data to ensure all columns align across all elections."
  )
  ...
  expect_message(
    result_2010 <- process_reps(data_2010, "2010 Federal Election"),
  ...
  expect_message(
    result_2013 <- process_reps(data_2013, "2013 Federal Election"),

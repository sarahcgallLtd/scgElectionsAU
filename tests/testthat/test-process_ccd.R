test_that("process_ccd standardises election data correctly", {
  ...
  expect_message(
    result_2025 <- process_ccd(data_2025, "2025"),
  ...
  expect_message(
    result_2013 <- process_ccd(data_2013, "2013"),
  ...
  expect_equal(result_2013$StateAb, "New South Wales")
  ...
  expect_message(
    result_2016 <- process_ccd(data_2016, "2016"),
  ...
  expect_equal(result_2016$StateAb, "Victoria")
  ...
  expect_message(
    result_2019 <- process_ccd(data_2019, "2019"),
  ...
  expect_equal(result_2019$StateAb, "Queensland")
  ...
  expect_message(
    result_2022 <- process_ccd(data_2022, "2022"),

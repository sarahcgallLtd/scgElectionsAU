test_that("process_overseas handles event values and data processing correctly", {
  ...
  expect_message(
    result_2013 <- process_overseas(data_2013, "2013 Federal Election"),
  ...
  expect_message(
    result_2019 <- process_overseas(data_2019, "2019 Federal Election"),
  ...
  expect_message(
    result_2022 <- process_overseas(data_2022, "2022 Federal Election"),

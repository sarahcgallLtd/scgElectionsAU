...
Covering elections from `2004` to the present, this dataset is available for both the `House` and `Senate`. No changes are made.
...
Covering elections from `2004` to the present, this dataset is available for both the `House` and `Senate`. Minor amendments are made to the original dataset, changing `PrePollVotes` to `DeclarationPrePollVotes`. This ensures consistency in column names across all datasets.

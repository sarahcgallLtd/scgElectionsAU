...
kable(df[1:3,], format = "html", table.attr = "class='table table-bordered'")
```
...
df <- suppressMessages(
  prepare_boundaries(
    ...
    compare_to = "2019 Federal Election"
  )
)
kable(df[1:3,], format = "html", table.attr = "class='table table-bordered'")
```
